...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 2.85    // Unit: mm compression per 1mm/s extruder speed
...
#define ADVANCED_PAUSE_FEATURE
  ...
  // TODO max: Most values are custom from https://www.youtube.com/watch?v=e4oGcQ6QLl8
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     35  // (mm/s) Unload filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  // NOTE max: Current bowden tube is about ~840 + 30 until stepper
  ...
  #define FILAMENT_UNLOAD_PURGE_LENGTH        35  // (mm) An unretract is done, then this length is purged.
