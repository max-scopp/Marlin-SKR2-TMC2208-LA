...
#define STRING_CONFIG_H_AUTHOR "(max-scopp, Creality Ender-5 Plus)" // Who made the changes.
...
#define MACHINE_UUID "536ffeb9-99a6-402f-a46e-a3be17beabbd"
...
// NOTE max: one whole meter due to long loading/unloading filament distance of ~800 (might lower that to 400 with new designs)
...
// TODO: max heated chamber: Posted until proper case setup; research display of chamber temps
...
// NOTE max: E steps adjusted to 98.15 as per real-life test [here](https://teachingtechyt.github.io/calibration.html#esteps)
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 98.15 }
...
// TODO max: rubienr had a value of 0.5, currently using Creality's value
...
// NOTE max: rubienr used { -44, -5, -2.85 }, which is too tight for my case; -2.8~-2.9 worked best no matter how often I lossened/unmounted it.
#define NOZZLE_TO_PROBE_OFFSET { -44, -5, -2.85 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
// NOTE max: rubienr used 5, I prefer a wider margin when using the true whole bed
...
// TODO max: Does this move the bed on prints? I have no idea.
